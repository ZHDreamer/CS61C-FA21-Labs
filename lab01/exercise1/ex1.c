...
int
num_occurrences (char *str, char letter)
{
  /* DONE: implement num_occurances */
...
void
compute_nucleotide_occurrences (DNA_sequence *dna_seq)
{
  /* DONE: implement compute_nucleotide_occurances */
